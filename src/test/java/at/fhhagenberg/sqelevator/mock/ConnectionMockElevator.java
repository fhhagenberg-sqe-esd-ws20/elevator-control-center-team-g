...
public class ConnectionMockElevator implements IElevatorWrapper{
    ...
    // CTOR
    public ConnectionMockElevator(int number_elevators, int number_floors, int floor_height, int capacity) {
